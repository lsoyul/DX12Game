...
void Engine::Init(const WindowInfo& info)
{
	...
	_computeCmdQueue->Init(_device->GetDevice());	// 스왑체인 필요없음
	_swapChain->Init(info, _device->GetDevice(), _device->GetDXGI(), _graphicsCmdQueue->GetComQueue());
	_rootSignature->Init();
...
void Engine::Update()
{
	...
	GET_SINGLE(SceneManager)->Update(); // Update, LateUpdate, FinalUpdate
