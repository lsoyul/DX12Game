...
void Shader::Init(const wstring& path, ShaderInfo info, const string& vs, const string& ps)
{
	...
	{
		{"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, /*float3*/0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
		{"TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0,	/*float2*/12, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
		{"NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0,	/*float2*/20, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
		{"TANGENT", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0,	/*float2*/32, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
